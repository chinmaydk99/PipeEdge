...
from pipeedge.models.transformers import bert, deit, vit_snip
import devices
...
_model_cfg_add('google/vit-base-patch16-224', 48, 'ViT-B_16-224.npz',
               vit_snip.ViTShardForImageClassification, 'ViT-B_16-224_SNIP_pruned.npz')
_model_cfg_add('google/vit-large-patch16-224', 96, 'ViT-L_16-224.npz',
               vit_snip.ViTShardForImageClassification)
