...
from pipeedge.models.transformers import bert, deit, vit_apt
import devices
...
_model_cfg_add('google/vit-base-patch16-224', 48, 'ViT-B_16-224.npz',
               vit_apt.ViTShardForImageClassification, 'ViT-B_16-224_SNIP_pruned.npz')
# Add version with calibration support
_model_cfg_add('google/vit-base-patch16-224-calib', 48, 'ViT-B_16-224.npz',
               vit_apt.ViTShardForImageClassification, 'ViT-B_16-224_WANDA_calibrated.npz')
_model_cfg_add('google/vit-large-patch16-224', 96, 'ViT-L_16-224.npz',
               vit_apt.ViTShardForImageClassification)
# Add version with calibration support
_model_cfg_add('google/vit-large-patch16-224-calib', 96, 'ViT-L_16-224.npz',
               vit_apt.ViTShardForImageClassification, 'ViT-L_16-224_WANDA_calibrated.npz')
...
_model_cfg_add('google/vit-huge-patch14-224-in21k-calib', 128, 'ViT-H_14.npz',
               vit_apt.ViTShardForImageClassification, 'ViT-H_14_WANDA_calibrated.npz')
