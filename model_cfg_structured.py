...
from pipeedge.models.transformers import bert, deit, vit_structured
import devices
...
_model_cfg_add('google/vit-base-patch16-224', 48, 'ViT-B_16-224.npz',
               vit_structured.ViTShardForImageClassification, 'ViT-B_16-224_structured_pruned.npz')
# Add version with calibration support
_model_cfg_add('google/vit-base-patch16-224-calib', 48, 'ViT-B_16-224.npz',
               vit_structured.ViTShardForImageClassification, 'ViT-B_16-224_structured_lora.npz')
_model_cfg_add('google/vit-large-patch16-224', 96, 'ViT-L_16-224.npz',
               vit_structured.ViTShardForImageClassification, 'ViT-L_16-224_structured_pruned.npz')
# Add version with calibration support
_model_cfg_add('google/vit-large-patch16-224-calib', 96, 'ViT-L_16-224.npz',
               vit_structured.ViTShardForImageClassification, 'ViT-L_16-224_structured_lora.npz')
...
_model_cfg_add('google/vit-huge-patch14-224-in21k', 128, 'ViT-H_14.npz',
               vit_structured.ViTShardForImageClassification, 'ViT-H_14_structured_pruned.npz')
# Add version with calibration support
_model_cfg_add('google/vit-huge-patch14-224-in21k-calib', 128, 'ViT-H_14.npz',
               vit_structured.ViTShardForImageClassification, 'ViT-H_14_structured_lora.npz')
...
def get_model_config(model_name: str, model_file = None) -> Any:
    ...
    if model_name.split('/')[0] == 'torchvision':
        ...
        # For calibration versions, use the base model name for config
